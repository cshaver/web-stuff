# Useful web tools and bookmarks etc etc

* PerfectPixel
* http://csstriggers.com/
* http://sassdoc.com/
* http://staging.lolkit.leagueoflegends.com/docs/index.html
* http://lab.hakim.se/reveal-js/

## Inspiration
* http://tobiasahlin.com/typesource/
* http://hellohappy.org/beautiful-web-type/
* http://codepen.io/acjdesigns/pen/bNgqPq
* http://codepen.io/cedricdelpoux/pen/MaRjLy
